...
try {
    ...
    $delegation = "КАК РАБОТАТЬ (обязательно, это рой, а не одиночная сессия): " +
        ...
        "и модели не возвращает вовсе. Спавни агента с посоветованной моделью; совет НЕ " +
        "обязателен к исполнению — он вероятностный и на малой статистике ошибается, и " +
        "если противоречит существу задачи, бери свою и скажи в отчёте, почему. " +
