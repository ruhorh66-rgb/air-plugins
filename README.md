...
- **site-builder** — brief-in, website-out. Dynamic Next.js scaffolder with vendored copies of the MIT [UI/UX Pro Max](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) design skills, the MIT [taste-skill](https://github.com/Leonxlnx/taste-skill) (design direction) and Emil Kowalski's MIT [animation skills](https://github.com/emilkowalski/skills) (motion craft + audit) + shadcn/ui + Framer Motion, with optional [Glif](https://glif.app) MCP for generated visuals. See `site-builder/README.md`.
