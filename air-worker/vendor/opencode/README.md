...
AirWorker 0.10.5 vendors the official OpenCode Windows x64 baseline archive as a ready coding-agent shell. AirWorker does not fork or modify OpenCode and does not use it for provider/model selection.
