...
// Gates — сколько гейтов ПЛАНА ещё ОТКРЫТО (К40). Закрытый гейт — решение ЛПР уже принято,
// он сделан, а не ждёт: считать его в LPRGates значило бы держать «гейтов ЛПР» ненулевым
// навсегда после того, как человек уже ответил. Раньше здесь считались все шаги с Gate,
// закрытые тоже, и planstate.go документировал обратное, чем реально делал код.
